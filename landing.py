...
# Vata Dosha
with col1:
    st.image("https://i.imgur.com/lzvGIUW.png", caption="Vata Dosha")
    st.write("Vata Dosha")
    st.write(
...
# Pitta Dosha
with col2:
    st.image("https://i.imgur.com/UE2D26Z.png", caption="Pitta Dosha")
...
# Kapha Dosha
with col3:
    st.image("https://i.imgur.com/bx8owFD.png", caption="Kapha Dosha")
